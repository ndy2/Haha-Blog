...
*좋은 설계*와 *객체지향 방법론*에 관심이 많은 ==미래의 백엔드 개발자 남득윤==입니다. ![my-profile.jpeg|200](my-profile.jpeg){ align=right width="200"}
...
## 저는 요즘 ...
- [스프링 부트로 개발하는 MSA 컴포넌트](http://www.yes24.com/Product/Goods/115306377) 라는 책을 읽고 있어요

- 유데미에서 [Reactive Programming 강의](https://www.udemy.com/course/complete-java-reactive-programming/) 를 듣고 있어요
	- 아직 지식이 부족하고 겉할기 수준이라 블로그에 정리할 정도는 안되지만 얼른 완강하고 Spring-Webflux 관련 공부도 해보고싶네요. 제 첫 `Udemy` 강의인데 앞으로는 `Udemy` 애용 할 것 같아요!
