...
ARP^Address^ ^Resolution^ ^Protocol^ 는 같은 ***네트워크 내에서*** 통신을 하기 위해 필요한 MAC 주소를 IP 주소를 이용해서 알아오는 프로토콜입니다.
...
이 [링크](https://www.quora.com/Is-ARP-is-a-layer-3-protocol-If-yes-why-it-is-not-a-layer-2-protocol) 에서는 이에 관한 다양한 의견을 확인 할 수 있습니다. ARP 가 Layer 3 라고 이야기 하는 의견과 Layer 2 라고 이야기 하는 의견 모두 동의 하는 점은 이 고약한 프로토콜을 Layer 2 혹은 Layer 3 에 명확하게 규정 내릴 수 없다는 점입니다. 각자 자신의 생각을 들어 어느 계층에 조금더 가까운 것 같다는 의견들입니다.
